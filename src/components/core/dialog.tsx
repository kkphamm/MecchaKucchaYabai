...
function Dialog({
  ...
  const baseId = useId();
  const ids = {
    dialog: `mkya-dialog-${baseId}`,
    title: `mkya-dialog-title-${baseId}`,
    description: `mkya-dialog-description-${baseId}`,
  };
    ...
    <AnimatePresence mode='wait'>
      {isOpen && (
        <motion.dialog
          ...
          className={cn(
            'fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 transform rounded-2xl border border-border bg-card p-0 shadow-[0_8px_24px_rgba(0,0,0,0.12)]',
